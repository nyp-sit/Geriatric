...
import sg.edu.nyp.silvervitality.MedBook.model.AlarmDBHelper;
import sg.edu.nyp.silvervitality.MedBook.model.AlarmModel;
...
public class DBHelperTest extends AndroidTestCase {
    ...
    private AlarmModel getModel() {
        ...
        model.setRepeatingDay(AlarmModel.FRDIAY, true);
    ...
    public void testCreateAlarm() {
        ...
        assertEquals(model.getRepeatingDay(AlarmModel.FRDIAY), returnModel.getRepeatingDay(AlarmModel.FRDIAY));
