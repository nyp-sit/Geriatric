...
public class ReminderEditActivity extends Activity {
    ...
    private void populateFields()  {
        ...
        if (mRowId != null) {
            ...
            mPostalCode.setText(reminder.getString(
                    reminder.getColumnIndexOrThrow(RemindersDbAdapter.KEY_POSTAL_CODE)));
    ...
    private void saveState() {
        ...
        if (mRowId == null) {
            ...
            long id = mDbHelper.createReminder(title, body, reminderDateTime, postalcode);
            if (id > 0) {
                mRowId = id;
            }
        } else {
            mDbHelper.updateReminder(mRowId, title, body, reminderDateTime,postalcode);
        }
